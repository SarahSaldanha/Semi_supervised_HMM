...
for (iteration in all_iterations){
  #for(ii in seq(0.00,0.463, by = 0.04)){
    for(ii in seq(0.00,0.75, by = 0.05)){
  #iteration<-all_iterations[1]
  #ii = 0
  
 data<-readRDS(paste0("D:/Dropbox/PhD/All.GPSandAXYS/AXY_DATA_METHODS_PAPER_NO_ID/HMMS/fitTrack_0.75/", iteration, "/Final_birdPrep_states_extracted_AWS_3states_", ii, ".rds"))
 
 test_states<-readRDS("D:/Dropbox/PhD/All.GPSandAXYS/AXY_DATA_METHODS_PAPER_NO_ID/HMMs/allks_for_cm_NOID_FINAL.rds")
 ...
 saveRDS(st, paste0("D:/Dropbox/PhD/All.GPSandAXYS/AXY_DATA_METHODS_PAPER_NO_ID/HMMS/fitTrack_0.75/All_states_for_consistency_analysis/P_", ii, "/", iteration, "_stateNEW.rds"))
 }
}
...
for(ii in seq(0.00,0.75, by = 0.05)){
  ...
  p <-paste0("D:/Dropbox/PhD/All.GPSandAXYS/AXY_DATA_METHODS_PAPER_NO_ID/HMMS/fitTrack_0.75/All_states_for_consistency_analysis/P_", ii, "/")
  setwd(p)
...
saveRDS(df, paste0("D:/Dropbox/PhD/All.GPSandAXYS/AXY_DATA_METHODS_PAPER_NO_ID/HMMS/fitTrack_0.75/Percent_consistency/Proportion_",ii ,".rds"))
